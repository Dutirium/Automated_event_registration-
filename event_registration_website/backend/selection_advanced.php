...
<form id="eventForm" method="POST" action="create_order_advanced.php">
    ...
    <div class="options">
        ...
        <label><input type="checkbox" name="technical[]" value="Prompt Engineering" data-price="80"><span class="option-box">Prompt Eng. (₹80)</span></label>
        <label><input type="checkbox" name="technical[]" value="Short Video Recording" data-price="50"><span class="option-box">Video Rec. (₹50)</span></label>
        <label><input type="checkbox" name="technical[]" value="Waste to Best" data-price="50"><span class="option-box">Waste 2 Best (₹50)</span></label>
        <label><input type="checkbox" name="technical[]" value="Blogging Competition" data-price="60"><span class="option-box">Blogging (₹60)</span></label>
        <label><input type="checkbox" name="technical[]" value="View with Review" data-price="50"><span class="option-box">Review (₹50)</span></label>
